    ...
    projectsContainer.innerHTML = projects
      ...
      <div class="project-card group cursor-pointer gsap-reveal ${
        ...
        <div class="flex gap-4">
          <a href="${
            project.demo
          }" target="_blank" rel="noopener noreferrer" class="text-coral font-bold hover:text-black dark:hover:text-white transition-colors border-b-2 border-coral hover:border-black dark:hover:border-white">Live Demo</a>
          ${
            project.code
              ? `<a href="${project.code}" target="_blank" rel="noopener noreferrer" class="text-gray-500 font-bold hover:text-black dark:hover:text-white transition-colors">View Code</a>`
              : ""
          }
        </div>
      </div>
